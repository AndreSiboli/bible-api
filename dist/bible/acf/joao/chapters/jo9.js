...
exports.jo9 = [
    ...
    { number: 10, text: "Diziam-lhe, pois: Como se te abriram os olhos?" },
    {
        number: 11,
    ...
    { number: 13, text: "Levaram, pois, aos fariseus o que dantes era cego." },
    {
        number: 14,
    ...
    {
        number: 18,
        text: "Os judeus, porém, não creram que ele tivesse sido cego, e que agora visse, enquanto não chamaram os pais do que agora via.",
    },
    {
        number: 19,
    ...
    { number: 38, text: "Ele disse: Creio, Senhor. E o adorou." },
    {
        number: 39,
        text: "E disse-lhe Jesus: Eu vim a este mundo para juízo, a fim de que os que não vêem vejam, e os que vêem sejam cegos.",
    },
    {
        number: 40,
