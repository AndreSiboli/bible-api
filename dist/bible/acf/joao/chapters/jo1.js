...
exports.jo1 = [
    ...
    {
        number: 12,
        text: "Mas, a todos quantos o receberam, deu-lhes o poder de serem feitos filhos de Deus, aos que crêem no seu nome;",
    },
    {
        number: 13,
    ...
    {
        number: 21,
        text: "E perguntaram-lhe: Então quê? És tu Elias? E disse: Não sou. És tu profeta? E respondeu: Não.",
    },
    {
        number: 22,
    ...
    {
        number: 26,
        text: "João respondeu-lhes, dizendo: Eu batizo com água; mas no meio devós está um a quem vós não conheceis.",
    },
    {
        number: 27,
        text: "Este é aquele que vem após mim, que é antes de mim, do qual eu não sou digno de desatar a correia da alparca.",
    },
    {
        number: 28,
    ...
    {
        number: 43,
        text: "No dia seguinte quis Jesus ir à Galiléia, e achou a Filipe, e disse-lhe: Segue-me.",
    },
    { number: 44, text: "E Filipe era de Betsaida, cidade de André e de Pedro." },
    {
        number: 45,
