...
exports.mc7 = [
    ...
    {
        number: 10,
        text: "Porque Moisés disse: Honra a teu pai e a tua mãe; e quem maldisser, ou o pai ou a mãe, certamente morrerá.",
    },
    {
        number: 11,
    ...
    {
        number: 14,
        text: "E, chamando outra vez a multidão, disse-lhes: Ouvi-me vós, todos, e compreendei.",
    },
    {
        number: 15,
    ...
    {
        number: 19,
        text: "Porque não entra no seu coração, mas no ventre, e é lançado fora, ficando puras todas as comidas?",
    },
    { number: 20, text: "E dizia: O que sai do homem isso contamina o homem." },
    {
        number: 21,
    ...
    {
        number: 31,
        text: "E ele, tornando a sair dos termos de Tiro e de Sidom, foi até ao mar da Galiléia, pelos confins de Decápolis.",
    },
    {
        number: 32,
