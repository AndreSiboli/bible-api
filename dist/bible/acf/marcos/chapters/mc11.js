...
exports.mc11 = [
    ...
    {
        number: 14,
        text: "E Jesus, falando, disse à figueira: Nunca mais coma alguém fruto de ti. E os seus discípulos ouviram isto.",
    },
    {
        number: 15,
        text: "E vieram a Jerusalém; e Jesus, entrando no templo, começou a expulsar os que vendiam e compravam no templo; e derrubou as mesas dos cambiadores e as cadeiras dos que vendiam pombas.",
    },
    {
        number: 16,
    ...
    {
        number: 18,
        text: "E os escribas e príncipes dos sacerdotes, tendo ouvido isto, buscavam ocasião para o matar; pois eles o temiam, porque toda a multidão estava admirada acerca da sua doutrina.",
    },
    { number: 19, text: "E, sendo já tarde, saiu para fora da cidade." },
    {
        number: 20,
    ...
    { number: 22, text: "E Jesus, respondendo, disse-lhes: Tende fé em Deus;" },
    {
        number: 23,
    ...
    {
        number: 27,
        text: "E tornaram a Jerusalém, e, andando ele pelo templo, os principais dos sacerdotes, e os escribas, e os anciãos, se aproximaram dele.",
    },
    {
        number: 28,
