...
exports.fco14 = [
    ...
    {
        number: 27,
        text: "E, se alguém falar em língua desconhecida, faça-se isso por dois, ou quando muito três, e por sua vez, e haja intérprete.",
    },
    {
        number: 28,
        text: "Mas, se não houver intérprete, esteja calado na igreja, e fale consigo mesmo, e com Deus.",
    },
    { number: 29, text: "E falem dois ou três profetas, e os outros julguem." },
    {
        number: 30,
    ...
    { number: 38, text: "Mas, se alguém ignora isto, que ignore." },
    {
        number: 39,
        text: "Portanto, irmãos, procurai, com zelo, profetizar, e não proibais falar línguas.",
    },
    { number: 40, text: "Mas faça-se tudo decentemente e com ordem." },
];
