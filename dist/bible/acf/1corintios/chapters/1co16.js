...
exports.fco16 = [
    ...
    { number: 4, text: "E, se valer a pena que eu também vá, irão comigo." },
    {
        number: 5,
    ...
    { number: 8, text: "Ficarei, porém, em Éfeso até ao Pentecostes;" },
    {
        number: 9,
    ...
    { number: 14, text: "Todas as vossas coisas sejam feitas com amor." },
    {
        number: 15,
    ...
    {
        number: 19,
        text: "As igrejas da Ásia vos saúdam. Saúdam-vos afetuosamente no Senhor áqüila e Priscila, com a igreja que está em sua casa.",
    },
    {
        number: 20,
        text: "Todos os irmãos vos saúdam. Saudai-vos uns aos outros com ósculo santo.",
    },
    { number: 21, text: "Saudação da minha própria mão, de Paulo." },
    {
        number: 22,
        text: "Se alguém não ama ao Senhor Jesus Cristo, seja anátema. Maranata!",
    },
    { number: 23, text: "A graça do Senhor Jesus Cristo seja convosco." },
    { number: 24, text: "O meu amor seja com todos vós em Cristo Jesus. Amém." },
];
