...
exports.fco15 = [
    ...
    { number: 5, text: "E que foi visto por Cefas, e depois pelos doze." },
    {
        number: 6,
    ...
    {
        number: 8,
        text: "E por derradeiro de todos me apareceu também a mim, como a um abortivo.",
    },
    {
        number: 9,
    ...
    { number: 18, text: "E também os que dormiram em Cristo estão perdidos." },
    {
        number: 19,
    ...
    { number: 30, text: "Por que estamos nós também a toda a hora em perigo?" },
    {
        number: 31,
        text: "Eu protesto que cada dia morro, gloriando-me em vós, irmãos, por Cristo Jesus nosso Senhor.",
    },
    {
        number: 32,
        text: "Se, como homem, combati em Éfeso contra as bestas, que me aproveita isso, se os mortos não ressuscitam? Comamos e bebamos, que amanhã morreremos.",
    },
    {
        number: 33,
    ...
    {
        number: 44,
        text: "Semeia-se corpo natural, ressuscitará corpo espiritual. Se há corpo natural, há também corpo espiritual.",
    },
    {
        number: 45,
