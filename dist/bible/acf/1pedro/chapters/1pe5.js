...
exports.fpe5 = [
    ...
    {
        number: 8,
        text: "Sede sóbrios; vigiai; porque o diabo, vosso adversário, anda em derredor, bramando como leão, buscando a quem possa tragar;",
    },
    {
        number: 9,
    ...
    {
        number: 10,
        text: "E o Deus de toda a graça, que em Cristo Jesus nos chamou à sua eterna glória, depois de havemos padecido um pouco, ele mesmo vos aperfeiçoe, confirme, fortifique e estabeleça.",
    },
    {
        number: 11,
    ...
    {
        number: 13,
        text: "A vossa co-eleita em babilônia vos saúda, e meu filho Marcos.",
    },
    {
        number: 14,
