...
exports.gl6 = [
    ...
    { number: 5, text: "Porque cada qual levará a sua própria carga." },
    {
        number: 6,
    ...
    {
        number: 15,
        text: "Porque em Cristo Jesus nem a circuncisão, nem a incircuncisão tem virtude alguma, mas sim o ser uma nova criatura.",
    },
    {
        number: 16,
