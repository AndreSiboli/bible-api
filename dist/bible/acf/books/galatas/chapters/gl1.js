...
exports.gl1 = [
    ...
    {
        number: 3,
        text: "Graça e paz da parte de Deus Pai e do nosso Senhor Jesus Cristo,",
    },
    {
        number: 4,
    ...
    { number: 5, text: "Ao qual seja dada glória para todo o sempre. Amém." },
    {
        number: 6,
    ...
    {
        number: 16,
        text: "Revelar seu Filho em mim, para que o pregasse entre os gentios, não consultei a carne nem o sangue,",
    },
    {
        number: 17,
    ...
    { number: 21, text: "Depois fui para as partes da Síria e da Cilícia." },
    {
        number: 22,
        text: "E não era conhecido de vista das igrejas da Judéia, que estavam em Cristo;",
    },
    {
        number: 23,
        text: "Mas somente tinham ouvido dizer: Aquele que já nos perseguiu anuncia agora a fé que antes destruía.",
    },
    { number: 24, text: "E glorificavam a Deus a respeito de mim." },
];
