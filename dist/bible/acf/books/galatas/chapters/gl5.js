...
exports.gl5 = [
    ...
    { number: 8, text: "Esta persuasão não vem daquele que vos chamou." },
    ...
    {
        number: 17,
        text: "Porque a carne cobiça contra o Espírito, e o Espírito contra a carne; e estes opõem-se um ao outro, para que não façais o que quereis.",
    },
    {
        number: 18,
    ...
    {
        number: 20,
        text: "Idolatria, feitiçaria, inimizades, porfias, emulações, iras, pelejas, dissensões, heresias,",
    },
    {
        number: 21,
        text: "Invejas, homicídios, bebedices, glutonarias, e coisas semelhantes a estas, acerca das quais vos declaro, como já antes vos disse, que os que cometem tais coisas não herdarão o reino de Deus.",
    },
    {
        number: 22,
        text: "Mas o fruto do Espírito é: amor, gozo, paz, longanimidade, benignidade, bondade, fé, mansidão, temperança.",
    },
    { number: 23, text: "Contra estas coisas não há lei." },
    {
        number: 24,
        text: "E os que são de Cristo crucificaram a carne com as suas paixões e concupiscências.",
    },
    { number: 25, text: "Se vivemos em Espírito, andemos também em Espírito." },
    {
        number: 26,
