...
exports.cl3 = [
    ...
    {
        number: 5,
        text: "Mortificai, pois, os vossos membros, que estão sobre a terra: a fornicação, a impureza, o afeição desordenada, a vil concupiscência, e a avareza, que é idolatria;",
    },
    {
        number: 6,
    ...
    {
        number: 19,
        text: "Vós, maridos, amai a vossas mulheres, e não vos irriteis contra elas.",
    },
    {
        number: 20,
