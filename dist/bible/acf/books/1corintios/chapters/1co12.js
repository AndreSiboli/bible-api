...
exports.fco12 = [
    ...
    { number: 4, text: "Ora, há diversidade de dons, mas o Espírito é o mesmo." },
    {
        number: 5,
    ...
    {
        number: 8,
        text: "Porque a um pelo Espírito é dada a palavra da sabedoria; e a outro, pelo mesmo Espírito, a palavra da ciência;",
    },
    {
        number: 9,
    ...
    {
        number: 12,
        text: "Porque, assim como o corpo é um, e tem muitos membros, e todos os membros, sendo muitos, são um só corpo, assim é Cristo também.",
    },
    {
        number: 13,
    ...
    { number: 14, text: "Porque também o corpo não é um só membro, mas muitos." },
    {
        number: 15,
    ...
    { number: 20, text: "Assim, pois, há muitos membros, mas um corpo." },
    {
        number: 21,
    ...
    {
        number: 22,
        text: "Antes, os membros do corpo que parecem ser os mais fracos são necessários;",
    },
    {
        number: 23,
