...
exports.fco11 = [
    { number: 1, text: "Sede meus imitadores, como também eu de Cristo." },
    {
        number: 2,
    ...
    {
        number: 34,
        text: "Mas, se algum tiver fome, coma em casa, para que não vos ajunteis para condenação. Quanto às demais coisas, ordená-las-ei quando for.",
    },
];
