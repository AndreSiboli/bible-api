...
exports.fco10 = [
    ...
    { number: 2, text: "E todos foram batizados em Moisés, na nuvem e no mar," },
    { number: 3, text: "E todos comeram de uma mesma comida espiritual," },
    {
        number: 4,
    ...
    {
        number: 8,
        text: "E não nos forniquemos, como alguns deles fizeram; e caíram num dia vinte e três mil.",
    },
    {
        number: 9,
    ...
    {
        number: 11,
        text: "Ora, tudo isto lhes sobreveio como figuras, e estão escritas para aviso nosso, para quem já são chegados os fins dos séculos.",
    },
    { number: 12, text: "Aquele, pois, que cuida estar em pé, olhe não caia." },
    {
        number: 13,
    ...
    { number: 14, text: "Portanto, meus amados, fugi da idolatria." },
    { number: 15, text: "Falo como a entendidos; julgai vós mesmos o que digo." },
    {
        number: 16,
    ...
    {
        number: 24,
        text: "Ninguém busque o proveito próprio; antes cada um o que é de outrem.",
    },
    {
        number: 25,
        text: "Comei de tudo quanto se vende no açougue, sem perguntar nada, por causa da consciência.",
    },
    { number: 26, text: "Porque a terra é do Senhor e toda a sua plenitude." },
    {
        number: 27,
    ...
    {
        number: 29,
        text: "Digo, porém, a consciência, não a tua, mas a do outro. Pois por que há de a minha liberdade ser julgada pela consciência de outrem?",
    },
    {
        number: 30,
