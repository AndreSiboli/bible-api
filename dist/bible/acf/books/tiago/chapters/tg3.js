...
exports.tg3 = [
    ...
    {
        number: 6,
        text: "A língua também é um fogo; como mundo de iniqüidade, a língua está posta entre os nossos membros, e contamina todo o corpo, e inflama o curso da natureza, e é inflamada pelo inferno.",
    },
    {
        number: 7,
    ...
    {
        number: 14,
        text: "Mas, se tendes amarga inveja, e sentimento faccioso em vosso coração, não vos glorieis, nem mintais contra a verdade.",
    },
    {
        number: 15,
    ...
    {
        number: 16,
        text: "Porque onde há inveja e espírito faccioso aí há perturbação e toda a obra perversa.",
    },
    {
        number: 17,
