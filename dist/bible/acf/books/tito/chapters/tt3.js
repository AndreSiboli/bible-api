...
exports.tt3 = [
    {
        number: 1,
        text: "Admoesta-os a que se sujeitem aos principados e potestades, que lhes obedeçam, e estejam preparados para toda a boa obra;",
    },
    {
        number: 2,
    ...
    {
        number: 8,
        text: "Fiel é a palavra, e isto quero que deveras afirmes, para que os que crêem em Deus procurem aplicar-se às boas obras; estas coisas são boas e proveitosas aos homens.",
    },
    {
        number: 9,
    ...
    {
        number: 10,
        text: "Ao homem hereje, depois de uma e outra admoestação, evita-o,",
    },
    {
        number: 11,
