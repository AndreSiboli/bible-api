...
exports.fpe2 = [
    ...
    {
        number: 5,
        text: "Vòs também, como pedras vivas, sois edificados casa espiritual e sacerdòcio santo, para oferecer sacrifícios espirituais agradáveis a Deus por Jesus Cristo.",
    },
    {
        number: 6,
    ...
    {
        number: 7,
        text: "E assim para vòs, os que credes, é preciosa, mas, para os rebeldes,a pedra que os edificadores reprovaram,essa foi a principal da esquina,",
    },
    {
        number: 8,
    ...
    {
        number: 9,
        text: "Mas vòs sois a geração eleita, o sacerdòcio real, a nação santa, o povo adquirido, para que anuncieis as virtudes daquele que vos chamou das trevas para a sua maravilhosa luz;",
    },
    {
        number: 10,
