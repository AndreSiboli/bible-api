...
exports.ssm23 = [
    ...
    { number: 25, text: "Samá, harodita; Elica, harodita;" },
    { number: 26, text: "Helez, paltita; Ira, filho de Iques, tecoíta;" },
    { number: 27, text: "Abiezer, anatotita; Mebunai, husatita;" },
    { number: 28, text: "Zalmom, aoíta; Maarai, netofatita;" },
    {
        number: 29,
        text: "Elebe, filho de Baaná, netofatita; Itai, filho de Ribai, de Gibeá dos filhos de Benjamim;",
    },
    { number: 30, text: "Benaia, piratonita; Hidai, do ribeiro de Gaás;" },
    { number: 31, text: "Abi-Albom, arbatita; Azmavete, barumita;" },
    { number: 32, text: "Eliaba, saalbonita; os filhos de Jásen e Jônatas;" },
    { number: 33, text: "Samá, hararita, Aião, filho de Sarar, ararita;" },
    {
        number: 34,
        text: "Elifelete, filho de Aasbai, filho de um maacatita; Eliã, filho de Aitofel, gilonita;",
    },
    { number: 35, text: "Hesrai, carmelita; Paarai, arbita;" },
    { number: 36, text: "Igal, filho de Natã, de Zobá; Bani, gadita;" },
    {
        number: 37,
        text: "Zeleque, amonita; Naarai, beerotita, o que trazia as armas de Joabe, filho de Zeruia;",
    },
    { number: 38, text: "Ira, itrita; Garebe, itrita;" },
    { number: 39, text: "Urias, heteu; trinta e sete ao todo." },
];
