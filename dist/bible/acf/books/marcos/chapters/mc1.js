...
exports.mc1 = void 0;
exports.mc1 = [
    { number: 1, text: "Princípio do Evangelho de Jesus Cristo, Filho de Deus;" },
    {
        number: 2,
    ...
    {
        number: 5,
        text: "E toda a província da Judéia e os de Jerusalém iam ter com ele; e todos eram batizados por ele no rio Jordão, confessando os seus pecados.",
    },
    {
        number: 6,
        text: "E João andava vestido de pêlos de camelo, e com um cinto de couro em redor de seus lombos, e comia gafanhotos e mel silvestre.",
    },
    {
        number: 7,
        text: "E pregava, dizendo: Após mim vem aquele que é mais forte do que eu, do qual não sou digno de, abaixando-me, desatar a correia das suas alparcas.",
    },
    {
        number: 8,
    ...
    {
        number: 9,
        text: "E aconteceu naqueles dias que Jesus, tendo ido de Nazaré da Galiléia, foi batizado por João, no Jordão.",
    },
    {
        number: 10,
    ...
    { number: 12, text: "E logo o Espírito o impeliu para o deserto." },
    {
        number: 13,
    ...
    {
        number: 14,
        text: "E, depois que João foi entregue à prisão, veio Jesus para a Galiléia, pregando o evangelho do reino de Deus,",
    },
    {
        number: 15,
    ...
    {
        number: 16,
        text: "E, andando junto do mar da Galiléia, viu Simão, e André, seu irmão, que lançavam a rede ao mar, pois eram pescadores.",
    },
    {
        number: 17,
        text: "E Jesus lhes disse: Vinde após mim, e eu farei que sejais pescadores de homens.",
    },
    { number: 18, text: "E, deixando logo as suas redes, o seguiram." },
    {
        number: 19,
    ...
    {
        number: 20,
        text: "E logo os chamou. E eles, deixando o seu pai Zebedeu no barco com os jornaleiros, foram após ele.",
    },
    {
        number: 21,
    ...
    { number: 25, text: "E repreendeu-o Jesus, dizendo: Cala-te, e sai dele." },
    {
        number: 26,
    ...
    {
        number: 28,
        text: "E logo correu a sua fama por toda a província da Galiléia.",
    },
    {
        number: 29,
    ...
    { number: 33, text: "E toda a cidade se ajuntou à porta." },
    {
        number: 34,
    ...
    { number: 36, text: "E seguiram-no Simão e os que com ele estavam." },
    { number: 37, text: "E, achando-o, lhe disseram: Todos te buscam." },
    {
        number: 38,
    ...
    {
        number: 39,
        text: "E pregava nas sinagogas deles, por toda a Galiléia, e expulsava os demônios.",
    },
    {
        number: 40,
    ...
    { number: 43, text: "E, advertindo-o severamente, logo o despediu." },
    {
        number: 44,
