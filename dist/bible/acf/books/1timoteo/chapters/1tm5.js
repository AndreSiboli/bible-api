...
exports.ftm5 = [
    ...
    { number: 3, text: "Honra as viúvas que verdadeiramente são viúvas." },
    {
        number: 4,
    ...
    { number: 6, text: "Mas a que vive em deleites, vivendo está morta." },
    {
        number: 7,
    ...
    {
        number: 13,
        text: "E, além disto, aprendem também a andar ociosas de casa em casa; e não só ociosas, mas também paroleiras e curiosas, falando o que não convém.",
    },
    {
        number: 14,
        text: "Quero, pois, que as que são moças se casem, gerem filhos, governem a casa, e não dêem ocasião ao adversário de maldizer;",
    },
    { number: 15, text: "Porque já algumas se desviaram, indo após Satanás." },
    {
        number: 16,
        text: "Se algum crente ou alguma crente tem viúvas, socorra-as, e não se sobrecarregue a igreja, para que se possam sustentar as que deveras são viúvas.",
    },
    {
        number: 17,
    ...
    {
        number: 23,
        text: "Não bebas mais água só, mas usa de um pouco de vinho, por causa do teu estômago e das tuas freqüentes enfermidades.",
    },
    {
        number: 24,
