...
exports.ftm3 = [
    ...
    {
        number: 2,
        text: "Convém, pois, que o bispo seja irrepreensível, marido de uma mulher, vigilante, sóbrio, honesto, hospitaleiro, apto para ensinar;",
    },
    {
        number: 3,
    ...
    {
        number: 5,
        text: "(Porque, se alguém não sabe governar a sua própria casa, terá cuidado da igreja de Deus? );",
    },
    {
        number: 6,
    ...
    {
        number: 7,
        text: "Convém também que tenha bom testemunho dos que estão de fora, para que não caia em afronta, e no laço do diabo.",
    },
    {
        number: 8,
    ...
    { number: 9, text: "Guardando o mistério da fé numa consciência pura." },
    {
        number: 10,
