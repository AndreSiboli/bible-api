...
exports.ftm2 = [
    ...
    {
        number: 4,
        text: "Que quer que todos os homens se salvem, e venham ao conhecimento da verdade.",
    },
    {
        number: 5,
    ...
    {
        number: 7,
        text: "Para o que (digo a verdade em Cristo, não minto) fui constituído pregador, e apóstolo, e doutor dos gentios na fé e na verdade.",
    },
    {
        number: 8,
    ...
    { number: 11, text: "A mulher aprenda em silêncio, com toda a sujeição." },
    {
        number: 12,
        text: "Não permito, porém, que a mulher ensine, nem use de autoridade sobre o marido, mas que esteja em silêncio.",
    },
    { number: 13, text: "Porque primeiro foi formado Adão, depois Eva." },
    {
        number: 14,
    ...
    {
        number: 15,
        text: "Salvar-se-á, porém, dando à luz filhos, se permanecer com modéstia na fé, no amor e na santificação.",
    },
];
