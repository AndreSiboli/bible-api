...
exports.jo19 = void 0;
exports.jo19 = [
    { number: 1, text: "Pilatos, pois, tomou então a Jesus, e o açoitou." },
    {
        number: 2,
    ...
    {
        number: 6,
        text: "Vendo-o, pois, os principais dos sacerdotes e os servos, clamaram, dizendo: Crucifica-o, crucifica-o. Disse-lhes Pilatos: Tomai-o vós, e crucificai-o; porque eu nenhum crime acho nele.",
    },
    {
        number: 7,
    ...
    {
        number: 15,
        text: "Mas eles bradaram: Tira, tira, crucifica-o. Disse-lhes Pilatos: Hei de crucificar o vosso Rei? Responderam os principais dos sacerdotes: Não temos rei, senão César.",
    },
    {
        number: 16,
    ...
    {
        number: 28,
        text: "Depois, sabendo Jesus que já todas as coisas estavam terminadas, para que a Escritura se cumprisse, disse: Tenho sede.",
    },
    {
        number: 29,
    ...
    {
        number: 37,
        text: "E outra vez diz a Escritura: Verão aquele que traspassaram.",
    },
    {
        number: 38,
        text: "Depois disto, José de Arimatéia (o que era discípulo de Jesus, mas oculto, por medo dos judeus) rogou a Pilatos que lhe permitisse tirar o corpo de Jesus. E Pilatos lho permitiu. Então foi e tirou o corpo de Jesus.",
    },
    {
        number: 39,
    ...
    {
        number: 40,
        text: "Tomaram, pois, o corpo de Jesus e o envolveram em lençóis com as especiarias, como os judeus costumam fazer, na preparação para o sepulcro.",
    },
    {
        number: 41,
        text: "E havia um horto naquele lugar onde fora crucificado, e no horto um sepulcro novo, em que ainda ninguém havia sido posto.",
    },
    {
        number: 42,
