...
exports.jo8 = [
    ...
    {
        number: 9,
        text: "Quando ouviram isto, redargüidos da consciência, saíram um a um, a começar pelos mais velhos até aos últimos; ficou só Jesus e a mulher que estava no meio.",
    },
    {
        number: 10,
    ...
    { number: 27, text: "Mas não entenderam que ele lhes falava do Pai." },
    {
        number: 28,
        text: "Disse-lhes, pois, Jesus: Quando levantardes o Filho do homem, então conhecereis que EU SOU, e que nada faço por mim mesmo; mas isto falo como meu Pai me ensinou.",
    },
    {
        number: 29,
        text: "E aquele que me enviou está comigo. O Pai não me tem deixado só, porque eu faço sempre o que lhe agrada.",
    },
    { number: 30, text: "Dizendo ele estas coisas, muitos creram nele." },
    {
        number: 31,
    ...
    { number: 45, text: "Mas, porque vos digo a verdade, não me credes." },
    {
        number: 46,
        text: "Quem dentre vós me convence de pecado? E se vos digo a verdade, por que não credes?",
    },
    {
        number: 47,
