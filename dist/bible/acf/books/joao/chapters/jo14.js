...
exports.jo14 = [
    ...
    { number: 14, text: "Se pedirdes alguma coisa em meu nome, eu o farei." },
    ...
    { number: 18, text: "Não vos deixarei órfãos; voltarei para vós." },
    {
        number: 19,
    ...
    { number: 25, text: "Tenho-vos dito isto, estando convosco." },
    {
        number: 26,
