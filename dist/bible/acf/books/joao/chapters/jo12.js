...
exports.jo12 = [
    ...
    {
        number: 3,
        text: "Então Maria, tomando um arrátel de ungüento de nardo puro, de muito preço, ungiu os pés de Jesus, e enxugou-lhe os pés com os seus cabelos; e encheu-se a casa do cheiro do ungüento.",
    },
    {
        number: 4,
    ...
    {
        number: 5,
        text: "Por que não se vendeu este ungüento por trezentos dinheiros e não se deu aos pobres?",
    },
    {
        number: 6,
    ...
    {
        number: 10,
        text: "E os principais dos sacerdotes tomaram deliberação para matar também a Lázaro;",
    },
    {
        number: 11,
    ...
    {
        number: 18,
        text: "Por isso a multidão lhe saiu ao encontro, porque tinham ouvido que ele fizera este sinal.",
    },
    {
        number: 19,
    ...
    {
        number: 21,
        text: "Estes, pois, dirigiram-se a Filipe, que era de Betsaida da Galiléia, e rogaram-lhe, dizendo: Senhor, queríamos ver a Jesus.",
    },
    {
        number: 22,
    ...
    {
        number: 36,
        text: "Enquanto tendes luz, crede na luz, para que sejais filhos da luz. Estas coisas disse Jesus e, retirando-se, escondeu-se deles.",
    },
    {
        number: 37,
    ...
    {
        number: 39,
        text: "Por isso não podiam crer, entào Isaías disse outra vez:",
    },
    {
        number: 40,
    ...
    {
        number: 50,
        text: "E sei que o seu mandamento é a vida eterna. Portanto, o que eu falo, falo-o como o Pai mo tem dito.",
    },
];
