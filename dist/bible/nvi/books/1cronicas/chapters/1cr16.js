...
exports.fcr16 = [
    ...
    { number: 9, text: 'Cantem para ele, louvem-no; contem todos os seus atos maravilhosos.' },
    {
        number: 10,
        text: 'Gloriem-se no seu santo nome; alegrem-se os corações dos que buscam o Senhor.',
    },
    { number: 11, text: 'Olhem para o Senhor e para a sua força; busquem sempre a sua face.' },
    {
        number: 12,
        text: 'Lembrem-se das maravilhas que ele fez, dos seus prodígios e das ordenanças que pronunciou,',
    },
    { number: 13, text: 'ó descendentes de Israel, seu servo, ó filhos de Jacó, seus escolhidos.' },
    { number: 14, text: 'Ele é o Senhor, o nosso Deus; seus domínio alcança toda a terra.' },
    {
        number: 15,
        text: 'Para sempre se lembra da sua aliança, da palavra que ordenou para mil gerações,',
    },
    { number: 16, text: 'da aliança que fez com Abraão, do juramento que fez a Isaque,' },
    {
        number: 17,
        text: 'que confirmou para Jacó como um decreto, e para Israel como uma aliança eterna, dizendo:',
    },
    { number: 18, text: '"A vocês darei a terra de Canaã, a herança que possuirão".' },
    { number: 19, text: 'Quando eles ainda eram poucos, muito poucos, e estrangeiros nela,' },
    { number: 20, text: 'e vagueavam de nação em nação, de um reino a outro,' },
    {
        number: 21,
        text: 'ele não permitiu que ninguém os oprimisse; por causa deles repreendeu reis, ordenando:',
    },
    { number: 22, text: '"Não maltratem os meus ungidos; não façam mal aos meus profetas".' },
    {
        number: 23,
    ...
    { number: 28, text: 'Dêem ao Senhor, ó famílias das nações, dêem ao Senhor glória e força.' },
    {
        number: 29,
    ...
    { number: 34, text: 'Rendam graças ao Senhor, pois ele é bom; o seu amor dura para sempre.' },
    {
        number: 35,
