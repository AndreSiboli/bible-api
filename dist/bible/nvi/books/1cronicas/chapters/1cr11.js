...
exports.fcr11 = [
    ...
    { number: 16, text: 'Estando Davi nessa fortaleza, e o destacamento filisteu em Belém,' },
    {
        number: 17,
    ...
    { number: 27, text: 'Samote, de Haror; Helez, de Pelom;' },
    { number: 28, text: 'Ira, filho de Iques, de Tecoa; Abiezer, de Anatote;' },
    { number: 29, text: 'Sibecai, de Husate; Ilai, de Aoí;' },
    { number: 30, text: 'Maarai, de Netofate; Helede, filho de Baaná, de Netofate;' },
    { number: 31, text: 'Itai, filho de Ribai, de Gibeá de Benjamim; Benaia, de Piratom;' },
    { number: 32, text: 'Hurai, dos riachos de Gaás; Abiel, de Arbate;' },
    { number: 33, text: 'Azmavete, de Baarum; Eliaba, de Saalbom;' },
    { number: 34, text: 'os filhos de Hasém, de Gizom; Jônatas, filho de Sage, de Harar;' },
    { number: 35, text: 'Aião, filho de Sacar, de Harar; Elifal, filho de Ur;' },
    { number: 36, text: 'Héfer, de Mequerate; Aías, de Pelom;' },
    { number: 37, text: 'Hezro, de Carmelo; Naarai, filho de Ezbai;' },
    { number: 38, text: 'Joel, irmão de Natã; Mibar, filho de Hagri;' },
    {
        number: 39,
        text: 'o amonita Zeleque; Naarai, de Beerote, escudeiro de Joabe, filho de Zeruia;',
    },
    { number: 40, text: 'Ira e Garebe, de Jatir;' },
    { number: 41, text: 'Urias, o hitita; Zabade, filho de Alai;' },
    {
        number: 42,
        text: 'Adina, filho de Siza, de Rúben, chefe dos rubenitas e do grupo dos trinta;',
    },
    { number: 43, text: 'Hanã, filho de Maaca; Josafá, de Mitene;' },
    { number: 44, text: 'Uzia, de Asterate; Sama e Jeiel, filhos de Hotão, de Aroer;' },
    { number: 45, text: 'Jediael, filho de Sinri; seu irmão, Joá, de Tiz;' },
    {
        number: 46,
        text: 'Eliel, de Maave; Jeribai e Josavias, filhos de Elnaão; Itma, um moabita,',
    },
    { number: 47, text: 'e Eliel, Obede e Jaasiel, de Mezoba.' },
];
