...
exports.hb11 = [
    ...
    { number: 2, text: 'Pois foi por meio dela que os antigos receberam bom testemunho.' },
    {
        number: 3,
    ...
    { number: 14, text: 'Os que assim falam mostram que estão buscando uma pátria.' },
    {
        number: 15,
    ...
    { number: 20, text: 'Pela fé Isaque abençoou Jacó e Esaú com respeito ao futuro deles.' },
    {
        number: 21,
    ...
    { number: 24, text: 'Pela fé Moisés, já adulto, recusou ser chamado filho da filha do faraó,' },
    {
        number: 25,
