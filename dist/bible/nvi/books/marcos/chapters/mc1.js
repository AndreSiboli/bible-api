...
exports.mc1 = void 0;
exports.mc1 = [
    { number: 1, text: 'Princípio do evangelho de Jesus Cristo, o Filho de Deus.' },
    {
        number: 2,
    ...
    { number: 8, text: 'Eu os batizo com água, mas ele os batizará com o Espírito Santo".' },
    {
        number: 9,
    ...
    { number: 12, text: 'Logo após, o Espírito o impeliu para o deserto.' },
    {
        number: 13,
    ...
    { number: 17, text: 'E disse Jesus: "Sigam-me, e eu os farei pescadores de homens".' },
    { number: 18, text: 'No mesmo instante eles deixaram as suas redes e o seguiram.' },
    {
        number: 19,
    ...
    { number: 25, text: '"Cale-se e saia dele! ", repreendeu-o Jesus.' },
    { number: 26, text: 'O espírito imundo sacudiu o homem violentamente e saiu dele gritando.' },
    {
        number: 27,
    ...
    { number: 33, text: 'Toda a cidade se reuniu à porta da casa,' },
    {
        number: 34,
    ...
    { number: 36, text: 'Simão e seus companheiros foram procurá-lo' },
    { number: 37, text: 'e, ao encontrá-lo, disseram: "Todos estão te procurando! "' },
    {
        number: 38,
    ...
    { number: 42, text: 'Imediatamente a lepra o deixou, e ele foi purificado.' },
    { number: 43, text: 'Em seguida Jesus o despediu, com uma severa advertência:' },
    {
        number: 44,
