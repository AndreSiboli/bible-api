...
exports.fts5 = void 0;
exports.fts5 = [
    { number: 1, text: 'Irmãos, quanto aos tempos e épocas, não precisamos escrever-lhes,' },
    {
        number: 2,
    ...
    { number: 16, text: 'Alegrem-se sempre.' },
    ...
    { number: 24, text: 'Aquele que os chama é fiel, e fará isso.' },
    { number: 25, text: 'Irmãos, orem por nós.' },
    { number: 26, text: 'Saúdem todos os irmãos com beijo santo.' },
    {
        number: 27,
        text: 'Responsabilizo-os diante do Senhor para que esta carta seja lida a todos os irmãos.',
    },
    { number: 28, text: 'A graça de nosso Senhor Jesus Cristo seja com vocês.' },
];
