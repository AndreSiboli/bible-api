...
exports.fts4 = [
    ...
    { number: 4, text: 'Cada um saiba controlar o próprio corpo de maneira santa e honrosa,' },
    {
        number: 5,
    ...
    { number: 7, text: 'Porque Deus não nos chamou para a impureza, mas para a santidade.' },
    {
        number: 8,
    ...
    {
        number: 11,
        text: 'Esforcem-se para ter uma vida tranquila, cuidar dos seus próprios negócios e trabalhar com as próprias mãos, como nós os instruímos;',
    },
    {
        number: 12,
    ...
    { number: 18, text: 'Consolem-se uns aos outros com estas palavras.' },
];
