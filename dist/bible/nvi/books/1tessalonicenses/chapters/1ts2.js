...
exports.fts2 = void 0;
exports.fts2 = [
    { number: 1, text: 'Irmãos, vocês mesmos sabem que a visita que lhes fizemos não foi inútil.' },
    {
        number: 2,
    ...
    { number: 6, text: 'Nem buscamos reconhecimento humano, quer de vocês quer de outros.' },
    {
        number: 7,
    ...
    { number: 11, text: 'Pois vocês sabem que tratamos cada um como um pai trata seus filhos,' },
    {
        number: 12,
    ...
    { number: 20, text: 'De fato, vocês são a nossa glória e a nossa alegria.' },
];
