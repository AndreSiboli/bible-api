...
exports.fco14 = [
    ...
    { number: 13, text: 'Por isso, quem fala em língua, ore para que a possa interpretar.' },
    {
        number: 14,
    ...
    { number: 18, text: 'Dou graças a Deus por falar em línguas mais do que todos vocês.' },
    {
        number: 19,
    ...
    { number: 30, text: 'Se vier uma revelação a alguém que está sentado, cale-se o primeiro.' },
    {
        number: 31,
        text: 'Pois vocês todos podem profetizar, cada um por sua vez, de forma que todos sejam instruídos e encorajados.',
    },
    { number: 32, text: 'Os espíritos dos profetas estão sujeitos aos profetas.' },
    {
        number: 33,
    ...
    { number: 38, text: 'Se ignorar isso, ele mesmo será ignorado.' },
    {
        number: 39,
        text: 'Portanto, meus irmãos, busquem com dedicação o profetizar e não proíbam o falar em línguas.',
    },
    { number: 40, text: 'Mas tudo deve ser feito com decência e ordem.' },
];
