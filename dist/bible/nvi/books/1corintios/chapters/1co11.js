...
exports.fco11 = void 0;
exports.fco11 = [
    { number: 1, text: 'Tornem-se meus imitadores, como eu o sou de Cristo.' },
    {
        number: 2,
    ...
    { number: 8, text: 'Pois o homem não se originou da mulher, mas a mulher do homem;' },
    {
        number: 9,
    ...
    { number: 20, text: 'Quando vocês se reúnem, não é para comer a ceia do Senhor,' },
    {
        number: 21,
    ...
    { number: 28, text: 'Examine-se o homem a si mesmo, e então coma do pão e beba do cálice.' },
    {
        number: 29,
        text: 'Pois quem come e bebe sem discernir o corpo do Senhor, come e bebe para sua própria condenação.',
    },
    { number: 30, text: 'Por isso há entre vocês muitos fracos e doentes, e vários já dormiram.' },
    { number: 31, text: 'Mas, se nós nos examinássemos a nós mesmos, não receberíamos juízo.' },
    {
        number: 32,
