...
exports.fco7 = [
    ...
    { number: 6, text: 'Digo isso como concessão, e não como mandamento.' },
    {
        number: 7,
    ...
    { number: 8, text: 'Digo, porém, aos solteiros e às viúvas: é bom que permaneçam como eu.' },
    {
        number: 9,
    ...
    { number: 20, text: 'Cada um deve permanecer na condição em que foi chamado por Deus.' },
    {
        number: 21,
    ...
    { number: 23, text: 'Vocês foram comprados por alto preço; não se tornem escravos de homens.' },
    {
        number: 24,
