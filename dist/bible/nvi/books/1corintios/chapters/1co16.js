...
exports.fco16 = [
    ...
    { number: 4, text: 'Se me parecer conveniente ir também, eles me acompanharão.' },
    { number: 5, text: 'Depois de passar pela Macedônia irei visitá-los, já que passarei por lá.' },
    {
        number: 6,
    ...
    { number: 8, text: 'Mas permanecerei em Éfeso até o Pentecoste,' },
    {
        number: 9,
    ...
    { number: 14, text: 'Façam tudo com amor.' },
    {
        number: 15,
    ...
    {
        number: 19,
        text: 'As igrejas da província da Ásia enviam-lhes saudações. Áquila e Priscila os saúdam afetuosamente no Senhor, e também a igreja que se reúne na casa deles.',
    },
    {
        number: 20,
        text: 'Todos os irmãos daqui lhes enviam saudações. Saúdem-se uns aos outros com beijo santo.',
    },
    { number: 21, text: 'Eu, Paulo, escrevi esta saudação de próprio punho.' },
    { number: 22, text: 'Se alguém não ama o Senhor, seja amaldiçoado. Vem, Senhor!' },
    { number: 23, text: 'A graça do Senhor Jesus seja com vocês.' },
    { number: 24, text: 'Recebam o amor que tenho por todos vocês em Cristo Jesus. Amém.' },
];
