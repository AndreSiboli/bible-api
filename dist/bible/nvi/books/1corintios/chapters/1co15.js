...
exports.fco15 = [
    ...
    { number: 4, text: 'foi sepultado e ressuscitou ao terceiro dia, segundo as Escrituras,' },
    { number: 5, text: 'e apareceu a Pedro e depois aos Doze.' },
    {
        number: 6,
    ...
    { number: 7, text: 'Depois apareceu a Tiago e, então, a todos os apóstolos;' },
    { number: 8, text: 'depois destes apareceu também a mim, como a um que nasceu fora de tempo.' },
    {
        number: 9,
    ...
    { number: 13, text: 'Se não há ressurreição dos mortos, então nem mesmo Cristo ressuscitou;' },
    {
        number: 14,
    ...
    { number: 16, text: 'Pois, se os mortos não ressuscitam, nem mesmo Cristo ressuscitou.' },
    {
        number: 17,
        text: 'E, se Cristo não ressuscitou, inútil é a fé que vocês têm, e ainda estão em seus pecados.',
    },
    { number: 18, text: 'Neste caso, também os que dormiram em Cristo estão perdidos.' },
    {
        number: 19,
    ...
    { number: 26, text: 'O último inimigo a ser destruído é a morte.' },
    {
        number: 27,
    ...
    { number: 30, text: 'Também nós, por que estamos nos expondo a perigos o tempo todo?' },
    {
        number: 31,
    ...
    { number: 33, text: 'Não se deixem enganar: "as más companhias corrompem os bons costumes".' },
    {
        number: 34,
    ...
    { number: 36, text: 'Insensato! O que você semeia não nasce a não ser que morra.' },
    {
        number: 37,
    ...
    { number: 47, text: 'O primeiro homem era do pó da terra; o segundo homem, do céu.' },
    {
        number: 48,
    ...
    { number: 56, text: 'O aguilhão da morte é o pecado, e a força do pecado é a lei.' },
    {
        number: 57,
