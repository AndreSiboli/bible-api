...
exports.fco12 = [
    ...
    { number: 4, text: 'Há diferentes tipos de dons, mas o Espírito é o mesmo.' },
    { number: 5, text: 'Há diferentes tipos de ministérios, mas o Senhor é o mesmo.' },
    {
        number: 6,
    ...
    { number: 14, text: 'O corpo não é composto de um só membro, mas de muitos.' },
    {
        number: 15,
    ...
    { number: 19, text: 'Se todos fossem um só membro, onde estaria o corpo?' },
    { number: 20, text: 'Assim, há muitos membros, mas um só corpo.' },
    {
        number: 21,
    ...
    { number: 30, text: 'Têm todos dons de curar? Falam todos em línguas? Todos interpretam?' },
    {
        number: 31,
