...
exports.fjo2 = [
    ...
    { number: 3, text: 'Sabemos que o conhecemos, se obedecemos aos seus mandamentos.' },
    {
        number: 4,
    ...
    { number: 6, text: 'aquele que afirma que permanece nele, deve andar como ele andou.' },
    {
        number: 7,
    ...
    { number: 9, text: 'Quem afirma estar na luz mas odeia seu irmão, continua nas trevas.' },
    { number: 10, text: 'Quem ama seu irmão permanece na luz, e nele não há causa de tropeço.' },
    {
        number: 11,
    ...
    { number: 26, text: 'Escrevo-lhes estas coisas a respeito daqueles que os querem enganar.' },
    {
        number: 27,
