...
exports.at2 = void 0;
exports.at2 = [
    { number: 1, text: 'Chegando o dia de Pentecoste, estavam todos reunidos num só lugar.' },
    {
        number: 2,
    ...
    { number: 8, text: 'Então, como os ouvimos, cada um de nós, em nossa própria língua materna?' },
    {
        number: 9,
    ...
    { number: 13, text: 'Alguns, todavia, zombavam deles e diziam: "Eles beberam vinho demais".' },
    {
        number: 14,
    ...
    { number: 16, text: 'Pelo contrário, isto é o que foi predito pelo profeta Joel:' },
    {
        number: 17,
    ...
    { number: 21, text: 'E todo aquele que invocar o nome do Senhor será salvo! ’' },
    {
        number: 22,
    ...
    { number: 32, text: 'Deus ressuscitou este Jesus, e todos nós somos testemunhas desse fato.' },
    {
        number: 33,
    ...
    { number: 35, text: 'até que eu ponha os teus inimigos como estrado para os teus pés’.' },
    {
        number: 36,
    ...
    { number: 44, text: 'Todos os que criam mantinham-se unidos e tinham tudo em comum.' },
    {
        number: 45,
