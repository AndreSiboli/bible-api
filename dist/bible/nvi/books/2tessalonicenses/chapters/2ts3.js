...
exports.sts3 = [
    ...
    { number: 3, text: 'Mas o Senhor é fiel; ele os fortalecerá e os guardará do Maligno.' },
    {
        number: 4,
    ...
    {
        number: 12,
        text: 'A tais pessoas ordenamos e exortamos no Senhor Jesus Cristo que trabalhem tranquilamente e comam o seu próprio pão.',
    },
    { number: 13, text: 'Quanto a vocês, irmãos, nunca se cansem de fazer o bem.' },
    {
        number: 14,
    ...
    { number: 18, text: 'A graça de nosso Senhor Jesus Cristo seja com todos vocês.' },
];
