...
exports.stm4 = [
    ...
    { number: 4, text: 'Eles se recusarão a dar ouvidos à verdade, voltando-se para os mitos.' },
    {
        number: 5,
    ...
    { number: 7, text: 'Combati o bom combate, terminei a corrida, guardei a fé.' },
    {
        number: 8,
    ...
    { number: 9, text: 'Procure vir logo ao meu encontro,' },
    {
        number: 10,
    ...
    { number: 12, text: 'Enviei Tíquico a Éfeso.' },
    {
        number: 13,
    ...
    { number: 15, text: 'Previna-se contra ele, porque se opôs fortemente às nossas palavras.' },
    {
        number: 16,
    ...
    { number: 19, text: 'Saudações a Priscila e Áquila, e à casa de Onesíforo.' },
    { number: 20, text: 'Erasto permaneceu em Corinto, mas deixei Trófimo doente em Mileto.' },
    {
        number: 21,
        text: 'Procure vir antes do inverno. Êubulo, Prudente, Lino, Cláudia e todos os irmãos enviam-lhe saudações.',
    },
    { number: 22, text: 'O Senhor seja com o seu espírito. A graça seja com vocês.' },
];
