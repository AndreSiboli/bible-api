...
exports.rm1 = [
    ...
    { number: 3, text: 'acerca de seu Filho, que, como homem, era descendente de Davi,' },
    {
        number: 4,
    ...
    { number: 6, text: 'E vocês também estão entre os chamados para pertencerem a Jesus Cristo.' },
    {
        number: 7,
    ...
    { number: 12, text: 'isto é, para que eu e vocês sejamos mutuamente encorajados pela fé.' },
    {
        number: 13,
    ...
    { number: 31, text: 'são insensatos, desleais, sem amor pela família, implacáveis.' },
    {
        number: 32,
