...
exports.at21 = [
    ...
    { number: 9, text: "Tinha este quatro filhas virgens que profetizavam." },
    {
        number: 10,
    ...
    {
        number: 13,
        text: "Então Paulo respondeu: Que fazeis chorando e magoando-me o coração? Porque eu estou pronto não só a ser ligado, mas ainda a morrer em Jerusalém pelo nome do Senhor Jesus.",
    },
    {
        number: 14,
    ...
    {
        number: 20,
        text: "Ouvindo eles isto, glorificaram a Deus, e disseram-lhe: Bem vês, irmãos, quantos milhares há entre os judeus que têm crido, e todos são zelosos da lei.",
    },
    {
        number: 21,
        text: "Têm sido informados a teu respeito que ensinas todos os judeus que estão entre os gentios a se apartarem de Moisés, dizendo que não circuncidem seus filhos, nem andem segundo os costumes da lei.",
    },
    {
        number: 22,
    ...
    {
        number: 29,
        text: "Antes tinham visto com ele na cidade a Trófimo de Éfeso, e pensavam que Paulo o introduzira no templo.",
    },
    {
        number: 30,
    ...
    {
        number: 31,
        text: "E, procurando eles matá-lo, chegou ao comandante da corte o aviso de que Jerusalém estava toda em confusão;",
    },
    {
        number: 32,
    ...
    {
        number: 34,
        text: "E na multidão uns gritavam de um modo, outros de outro; mas, não podendo por causa do alvoroço saber a verdade, mandou conduzi-lo à fortaleza.",
    },
    {
        number: 35,
        text: "E sucedeu que, chegando às escadas, foi ele carregado pelos soldados por causa da violência da turba.",
    },
    { number: 36, text: "Pois a multidão o seguia, clamando: Mata-o!" },
    {
        number: 37,
