...
exports.at20 = [
    ...
    { number: 5, text: "Estes porém, foram adiante e nos esperavam em Trôade." },
    {
        number: 6,
    ...
    {
        number: 9,
        text: "E certo jovem, por nome Êutico, que estava sentado na janela, tomado de um sono profundo enquanto Paulo prolongava ainda mais o seu sermão, vencido pelo sono caiu do terceiro andar abaixo, e foi levantado morto.",
    },
    {
        number: 10,
    ...
    { number: 12, text: "E levaram vivo o jovem e ficaram muito consolados." },
    {
        number: 13,
    ...
    { number: 17, text: "De Mileto mandou a Éfeso chamar os anciãos da igreja." },
    {
        number: 18,
    ...
    { number: 33, text: "De ninguém cobicei prata, nem ouro, nem vestes." },
    {
        number: 34,
