export const sco2 = [
  ...
  { number: 6, text: "Basta-lhe ao tal esta repreensão feita por muitos." },
  {
    number: 7,
  ...
  {
    number: 10,
    text: "E a quem perdoardes alguma coisa, também eu; porque, o que eu também perdoei, se é que tenho perdoado, por amor de vós o fiz na presença de Cristo; para que não sejamos vencidos por Satanás;",
  },
  { number: 11, text: "Porque não ignoramos os seus ardís." },
  {
    number: 12,
  ...
  {
    number: 17,
    text: "Porque nós não somos, como muitos, falsificadores da palavra de Deus, antes falamos de Cristo com sinceridade, como de Deus na presença de Deus.",
  },
];
