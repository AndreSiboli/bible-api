export const sco1 = [
  ...
  {
    number: 8,
    text: "Porque não queremos, irmãos, que ignoreis a tribulação que nos sobreveio na Ásia, pois que fomos sobremaneira agravados mais do que podíamos suportar, de modo tal que até da vida desesperamos.",
  },
  {
    number: 9,
    text: "Mas já em nós mesmos tínha- mos a sentença de morte, para que não confiássemos em nós, mas em Deus, que ressuscita os mortos;",
  },
  {
    number: 10,
  ...
  {
    number: 16,
    text: "E por vós passar à macedônia, e da macedônia ir outra vez ter convosco, e ser guiado por vós à Judéia.",
  },
  {
    number: 17,
