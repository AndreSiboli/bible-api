export const sco9 = [
  ...
  {
    number: 11,
    text: "Para que em tudo enriqueçais para toda a beneficência, a qual faz que por nós se dêem graças a Deus.",
  },
  {
    number: 12,
  ...
  { number: 15, text: "Graças a Deus, pois, pelo seu dom inefável." },
];
