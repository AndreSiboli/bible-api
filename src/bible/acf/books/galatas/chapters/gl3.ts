export const gl3 = [
  ...
  {
    number: 19,
    text: "Logo, para que é a lei? Foi ordenada por causa das transgressões, até que viesse a posteridade a quem a promessa tinha sido feita; e foi posta pelos anjos na mão de um medianeiro.",
  },
  { number: 20, text: "Ora, o medianeiro não o é de um só, mas Deus é um." },
  {
    number: 21,
  ...
  {
    number: 24,
    text: "De maneira que a lei nos serviu de aio, para nos conduzir a Cristo, para que pela fé fôssemos justificados.",
  },
  {
    number: 25,
