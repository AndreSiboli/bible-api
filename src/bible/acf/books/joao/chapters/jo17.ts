export const jo17 = [
  {
    number: 1,
    text: "Jesus falou assim e, levantando seus olhos ao céu, e disse: Pai, é chegada a hora; glorifica a teu Filho, para que também o teu Filho te glorifique a ti;",
  },
  {
    number: 2,
  ...
  { number: 16, text: "Não são do mundo, como eu do mundo não sou." },
  {
    number: 17,
  ...
  {
    number: 20,
    text: "E não rogo somente por estes, mas também por aqueles que pela tua palavra hão de crer em mim;",
  },
  {
    number: 21,
