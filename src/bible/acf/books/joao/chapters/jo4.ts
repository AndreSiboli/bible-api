export const jo4 = [
  ...
  { number: 4, text: "E era-lhe necessário passar por Samaria." },
  {
    number: 5,
  ...
  { number: 26, text: "Jesus disse-lhe: Eu o sou, eu que falo contigo." },
  {
    number: 27,
  ...
  { number: 30, text: "Saíram, pois, da cidade, e foram ter com ele." },
  {
    number: 31,
  ...
  { number: 41, text: "E muitos mais creram nele, por causa da sua palavra." },
  {
    number: 42,
  ...
  {
    number: 43,
    text: "E dois dias depois partiu dali, e foi para a Galiléia.",
  },
  {
    number: 44,
  ...
  {
    number: 45,
    text: "Chegando, pois, à Galiléia, os galileus o receberam, vistas todas as coisas que fizera em Jerusalém, no dia da festa; porque também eles tinham ido à festa.",
  },
  {
    number: 46,
    text: "Segunda vez foi Jesus a Caná da Galiléia, onde da água fizera vinho. E havia ali um nobre, cujo filho estava enfermo em Cafarnaum.",
  },
  {
    number: 47,
    text: "Ouvindo este que Jesus vinha da Judéia para a Galiléia, foi ter com ele, e rogou-lhe que descesse, e curasse o seu filho, porque já estava à morte.",
  },
  {
    number: 48,
  ...
  {
    number: 49,
    text: "Disse-lhe o nobre: Senhor, desce, antes que meu filho morra.",
  },
  {
    number: 50,
  ...
  {
    number: 54,
    text: "Jesus fez este segundo milagre, quando ia da Judéia para a Galiléia.",
  },
];
