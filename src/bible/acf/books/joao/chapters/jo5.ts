export const jo5 = [
  ...
  { number: 8, text: "Jesus disse-lhe: Levanta-te, toma o teu leito, e anda." },
  {
    number: 9,
  ...
  {
    number: 27,
    text: "E deu-lhe o poder de exercer o juízo, porque é o Filho do homem.",
  },
  {
    number: 28,
  ...
  {
    number: 35,
    text: "Ele era a candeia que ardia e alumiava, e vós quisestes alegrar-vos por um pouco de tempo com a sua luz.",
  },
  {
    number: 36,
  ...
  { number: 40, text: "E não quereis vir a mim para terdes vida." },
  { number: 41, text: "Eu não recebo glória dos homens;" },
  {
    number: 42,
