export const jo3 = [
  ...
  {
    number: 8,
    text: "O vento assopra onde quer, e ouves a sua voz, mas não sabes de onde vem, nem para onde vai; assim étodo aquele que é nascido do Espírito.",
  },
  ...
  {
    number: 22,
    text: "Depois disto foi Jesus com os seus discípulos para a terra da Judéia; e estava ali com eles, e batizava.",
  },
  {
    number: 23,
    text: "Ora, João batizava também em Enom, junto a Salim, porque havia ali muitas águas; e vinham ali, e eram batizados.",
  },
  { number: 24, text: "Porque ainda João não tinha sido lançado na prisão." },
  {
    number: 25,
