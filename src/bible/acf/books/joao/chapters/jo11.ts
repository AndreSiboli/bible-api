export const jo11 = [
  ...
  {
    number: 2,
    text: "E Maria era aquela que tinha ungido o Senhor com ungüento, e lhe tinha enxugado os pés com os seus cabelos, cujo irmão Lázaro estava enfermo.",
  },
  {
    number: 3,
  ...
  {
    number: 6,
    text: "Ouvindo, pois, que estava enfermo, ficou ainda dois dias no lugar onde estava.",
  },
  {
    number: 7,
    text: "Depois disto, disse aos seus discípulos: Vamos outra vez para a Judéia.",
  },
  {
    number: 8,
  ...
  {
    number: 11,
    text: "Assim falou; e depois disse-lhes: Lázaro, o nosso amigo, dorme, mas vou despertá-lo do sono.",
  },
  {
    number: 12,
  ...
  { number: 14, text: "Então Jesus disse-lhes claramente: Lázaro está morto;" },
  {
    number: 15,
  ...
  { number: 23, text: "Disse-lhe Jesus: Teu irmão há de ressuscitar." },
  {
    number: 24,
  ...
  {
    number: 26,
    text: "E todo aquele que vive, e crê em mim, nunca morrerá. Crês tu isto?",
  },
  {
    number: 27,
  ...
  { number: 36, text: "Disseram, pois, os judeus: Vede como o amava." },
  {
    number: 37,
  ...
  {
    number: 40,
    text: "Disse-lhe Jesus: Não te hei dito que, se creres, verás a glória de Deus?",
  },
  {
    number: 41,
  ...
  {
    number: 44,
    text: "E o defunto saiu, tendo as mãos e os pés ligados com faixas, e o seu rosto envolto num lenço. Disse-lhes Jesus: Desligai-o, e deixai-o ir.",
  },
  {
    number: 45,
  ...
  {
    number: 47,
    text: "Depois os principais dos sacerdotes e os fariseus formaram conselho, e diziam: Que faremos? porquanto este homem faz muitos sinais.",
  },
  {
    number: 48,
  ...
  {
    number: 57,
    text: "Ora, os principais dos sacerdotes e os fariseus tinham dado ordem para que, se alguém soubesse onde ele estava, o denunciasse, para o prenderem.",
  },
];
