export const tt2 = [
  { number: 1, text: "Tu, porém, fala o que convém à sã doutrina." },
  {
    number: 2,
  ...
  {
    number: 5,
    text: "A serem moderadas, castas, boas donas de casa, sujeitas a seus maridos, a fim de que a palavra de Deus não seja blasfemada.",
  },
  {
    number: 6,
  ...
  {
    number: 8,
    text: "Linguagem sã e irrepreensível, para que o adversário se envergonhe, não tendo nenhum mal que dizer de nós.",
  },
  {
    number: 9,
  ...
  {
    number: 13,
    text: "Aguardando a bem-aventurada esperança e o aparecimento da glória do grande Deus e nosso Senhor Jesus Cristo;",
  },
  {
    number: 14,
    text: "O qual se deu a si mesmo por nós para nos remir de toda a iniqüidade, e purificar para si um povo seu especial, zeloso de boas obras.",
  },
  {
    number: 15,
