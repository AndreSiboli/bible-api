export const tg1 = [
  ...
  { number: 3, text: "Sabendo que a prova da vossa fé opera a paciência." },
  {
    number: 4,
  ...
  {
    number: 8,
    text: "O homem de coração dobre é inconstante em todos os seus caminhos.",
  },
  { number: 9, text: "Mas glorie-se o irmão abatido na sua exaltação," },
  {
    number: 10,
  ...
  { number: 16, text: "Não erreis, meus amados irmãos." },
  {
    number: 17,
  ...
  { number: 20, text: "Porque a ira do homem não opera a justiça de Deus." },
  {
    number: 21,
  ...
  {
    number: 25,
    text: "Aquele, porém, que atenta bem para a lei perfeita da liberdade, e nisso persevera, não sendo ouvinte esquecediço, mas fazedor da obra, este tal será bem-aventurado no seu feito.",
  },
  {
    number: 26,
  ...
  {
    number: 27,
    text: "A religião pura e imaculada para com Deus e Pai, é esta: Visitar os órfãos e as viúvas nas suas tribulações, e guardar-se da corrupção do mundo.",
  },
];
