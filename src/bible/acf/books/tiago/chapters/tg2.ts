export const tg2 = [
  ...
  {
    number: 9,
    text: "Mas, se fazeis acepção de pessoas, cometeis pecado, e sois redargüidos pela lei como transgressores.",
  },
  {
    number: 10,
  ...
  {
    number: 15,
    text: "E, se o irmão ou a irmã estiverem nus, e tiverem falta de mantimento quotidiano,",
  },
  {
    number: 16,
    text: "E algum de vós lhes disser: Ide em paz, aquentai-vos, e fartai-vos; e nào lhes derdes as coisas necessárias para o corpo, que proveito virá daí?",
  },
  {
    number: 17,
  ...
  {
    number: 19,
    text: "Tu crês que há um só Deus; fazes bem. Também os demônios o crêem, e estremecem.",
  },
  {
    number: 20,
