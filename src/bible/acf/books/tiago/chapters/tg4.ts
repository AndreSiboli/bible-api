export const tg4 = [
  ...
  {
    number: 8,
    text: "Chegai-vos a Deus, e ele se chegará a vós. Alimpai as mãos, pecadores; e, vós de duplo ânimo, purificai os corações.",
  },
  {
    number: 9,
    text: "Senti as vossas misérias, e lamentai e chorai; converta-se o vosso riso em pranto, e o vosso gozo em tristeza.",
  },
  { number: 10, text: "Humilhai-vos perante o Senhor, e ele vos exaltará." },
  {
    number: 11,
  ...
  {
    number: 12,
    text: "Há só um legislador que pode salvar e destruir. Tu, porém, quem és, que julgas a outrem?",
  },
  {
    number: 13,
