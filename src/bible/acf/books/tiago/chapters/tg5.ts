export const tg5 = [
  ...
  {
    number: 4,
    text: "Eis que o jornal dos trabalhadores que ceifaram as vossas terras, e que por vós foi diminuído, clama; e os clamores dos que ceifaram entraram nos ouvidos do Senhor dos exércitos.",
  },
  {
    number: 5,
    text: "Deliciosamente vivestes sobre a terra, e vos deleitastes; cevastes os vossos corações, como num dia de matança.",
  },
  { number: 6, text: "Condenastes e matastes o justo; ele não vos resistiu." },
  {
    number: 7,
  ...
  {
    number: 20,
    text: "Saiba que aquele que fizer converter do erro do seu caminho um pecador, salvará da morte uma alma, e cobrirá uma multidão de pecados.",
  },
];
