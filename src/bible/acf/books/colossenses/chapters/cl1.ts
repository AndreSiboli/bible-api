export const cl1 = [
  ...
  { number: 8, text: "O qual nos declarou também o vosso amor no Espírito." },
  {
    number: 9,
  ...
  {
    number: 11,
    text: "Corroborados em toda a fortaleza, segundo a força da sua glória, em toda a paciência, e longanimidade com gozo;",
  },
  {
    number: 12,
  ...
  {
    number: 28,
    text: "A quem anunciamos, admoestando a todo o homem, e ensinando a todo o homem em toda a sabedoria; para que apresentemos todo o homem perfeito em Jesus Cristo;",
  },
  {
    number: 29,
