export const cl4 = [
  {
    number: 1,
    text: "Vós, senhores, fazei o que for de justiça e eqüidade a vossos servos, sabendo que também tendes um Senhor nos céus.",
  },
  { number: 2, text: "Perseverai em oração, velando nela com ação de graças;" },
  {
    number: 3,
  ...
  { number: 4, text: "Para que o manifeste, como me convém falar." },
  {
    number: 5,
  ...
  {
    number: 13,
    text: "Pois eu lhe dou testemunho de que tem grande zelo por vós, e pelos que estão em Laodicéia, e pelos que estão em Hierápolis.",
  },
  { number: 14, text: "Saúda-vos Lucas, o médico amado, e Demas." },
  {
    number: 15,
    text: "Saudai aos irmãos que estão em Laodicéia e a Ninfa e à igreja que está em sua casa.",
  },
  {
    number: 16,
    text: "E, quando esta epístola tiver sido lida entre vós, fazei que também o seja na igreja dos laodicenses, e a que veio de Laodicéia lede-a vós também.",
  },
  {
    number: 17,
