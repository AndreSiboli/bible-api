export const cl2 = [
  {
    number: 1,
    text: "Porque quero que saibais quão grande combate tenho por vós, e pelos que estão em Laodicéia, e por quantos não viram o meu rosto em carne;",
  },
  {
    number: 2,
    text: "Para que os seus corações sejam consolados, e estejam unidos em amor, e enriquecidos da plenitude da inteligência, para conhecimento do mistério de Deus e Pai, e de Cristo,",
  },
  {
    number: 3,
  ...
  {
    number: 7,
    text: "Arraigados e sobreedificados nele, e confirmados na fé, assim como fostes ensinados, nela abundando em ação de graças.",
  },
  {
    number: 8,
  ...
  {
    number: 18,
    text: "Ninguém vos domine a seu bel-prazer com pretexto de humildade e culto dos anjos, envolvendo-se em coisas que não viu; estando debalde inchado na sua carnal compreensão,",
  },
  {
    number: 19,
  ...
  { number: 21, text: "Não toques, não proves, não manuseies?" },
  {
    number: 22,
