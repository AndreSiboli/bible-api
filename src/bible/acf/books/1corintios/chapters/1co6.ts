export const fco6 = [
  ...
  {
    number: 4,
    text: "Então, se tiverdes negócios em juízo, pertencentes a esta vida, pondes para julga-los os que são de menos estima na igreja?",
  },
  {
    number: 5,
  ...
  {
    number: 10,
    text: "Não erreis: nem os devassos, nem os idólatras, nem os adúlteros, nem os efeminados, nem os sodomitas, nem os ladrões, nem os avarentos, nem os bêbados, nem os maldizentes, nem os roubadores herdarão o reino de Deus.",
  },
  {
    number: 11,
  ...
  {
    number: 16,
    text: "Ou não sabeis que o que se ajunta com a meretriz, faz-se um corpo com ela? Porque serão, disse, dois numa só carne.",
  },
  { number: 17, text: "Mas o que se ajunta com o Senhor é um mesmo espírito." },
  {
    number: 18,
