export const fco4 = [
  {
    number: 1,
    text: "Que os homens nos considerem como ministros de Cristo, e despenseiros dos mistérios de Deus.",
  },
  {
    number: 2,
    text: "Além disso requer-se dos despenseiros que cada um se ache fiel.",
  },
  {
    number: 3,
  ...
  {
    number: 5,
    text: "Portanto, nada julgueis antes de tempo, até que o Senhor venha, o qual também trará à luz as coisas ocultas das trevas, e manifestará os desígnios dos corações; e então cada um receberá de Deus o louvor.",
  },
  {
    number: 6,
  ...
  {
    number: 15,
    text: "Porque ainda que tivésseis dez mil aios em Cristo, não teríeis, contudo, muitos pais; porque eu pelo evangelho vos gerei em Jesus Cristo.",
  },
  { number: 16, text: "Admoesto-vos, portanto, a que sejais meus imitadores." },
  {
    number: 17,
