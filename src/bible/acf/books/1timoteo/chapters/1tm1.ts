export const ftm1 = [
  ...
  {
    number: 4,
    text: "Nem se dêem a fábulas ou a genealogias intermináveis, que mais produzem questões do que edificação de Deus, que consiste na fé; assim o faço agora.",
  },
  {
    number: 5,
  ...
  {
    number: 10,
    text: "Para os devassos, para os sodomitas, para os roubadores de homens, para os mentirosos, para os perjuros, e para o que for contrário à sã doutrina,",
  },
  {
    number: 11,
  ...
  {
    number: 17,
    text: "Ora, ao Rei dos séculos, imortal, invisível, ao único Deus sábio, seja honra e glória para todo o sempre. Amém.",
  },
  {
    number: 18,
