export const ftm6 = [
  {
    number: 1,
    text: "Todos os servos que estão debaixo do jugo estimem a seus senhores por dignos de toda a honra, para que o nome de Deus e a doutrina não sejam blasfemados.",
  },
  {
    number: 2,
  ...
  {
    number: 4,
    text: "É soberbo, e nada sabe, mas delira acerca de questões e contendas de palavras, das quais nascem invejas, porfias, blasfêmias, ruins suspeitas,",
  },
  {
    number: 5,
    text: "Perversas contendas de homens corruptos de entendimento, e privados da verdade, cuidando que a piedade seja causa de ganho; aparta-te dos tais.",
  },
  { number: 6, text: "Mas é grande ganho a piedade com contentamento." },
  {
    number: 7,
  ...
  {
    number: 17,
    text: "Manda aos ricos deste mundo que não sejam altivos, nem ponham a esperança na incerteza das riquezas, mas em Deus, que abundantemente nos dá todas as coisas para delas gozarmos;",
  },
  {
    number: 18,
