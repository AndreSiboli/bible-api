export const spe2 = [
  ...
  {
    number: 4,
    text: "Porque, se Deus não perdoou aos anjos que pecaram, mas, havendo-os lançado no inferno, os entregou às cadeias da escuridão, ficando reservados para o juízo;",
  },
  {
    number: 5,
    text: "E não perdoou ao mundo antigo, mas guardou a Noé, a oitava pessoa, o pregoeiro da justiça, ao trazer o dilúvio sobre o mundo dos ímpios;",
  },
  {
    number: 6,
  ...
  {
    number: 8,
    text: "(Porque este justo, habitando entre eles, afligia todos os dias a sua alma justa, por isso via e ouvia sobre as suas obras injustas);",
  },
  {
    number: 9,
  ...
  {
    number: 13,
    text: "Recebendo o galardão da injustiça; pois que tais homens têm prazer nos deleites quotidianos; nódoas são eles e máculas, deleitando-se em seus enganos, quando se banqueteiam convosco;",
  },
  {
    number: 14,
