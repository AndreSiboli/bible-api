export const spe1 = [
  ...
  {
    number: 5,
    text: "E vós também, pondo nisto mesmo toda a diligência, acrescentai à vossa fé a virtude, e à virtude a ciência,",
  },
  {
    number: 6,
    text: "E à ciência a temperança, e à temperança a paciência, e à paciência a piedade,",
  },
  {
    number: 7,
    text: "E à piedade o amor fraternal, e ao amor fraternal a caridade.",
  },
  {
    number: 8,
  ...
  {
    number: 14,
    text: "Sabendo que brevemente hei de deixar este meu tabernáculo, como também nosso Senhor Jesus Cristo já mo tem revelado.",
  },
  {
    number: 15,
  ...
  {
    number: 16,
    text: "Porque não vos fizemos saber a virtude e a vinda de nosso Senhor Jesus Cristo, seguindo fábulas artificialmente compostas; mas nós mesmos vimos a sua majestade.",
  },
  {
    number: 17,
  ...
  {
    number: 19,
    text: "E temos, mui firme, a palavra dos profetas, à qual bem fazeis em estar atentos, como a uma luz que alumia em lugar escuro, até que o dia amanheça, e a estrela da alva apareça em vossos corações.",
  },
  {
    number: 20,
