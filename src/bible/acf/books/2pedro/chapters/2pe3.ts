export const spe3 = [
  ...
  {
    number: 2,
    text: "Para que vos lembreis das palavras que primeiramente foram ditas pelos santos profetas, e do nosso mandamento, como apòstolos do Senhor e Salvador.",
  },
  {
    number: 3,
  ...
  {
    number: 18,
    text: "Antes crescei na graça e conhecimento de nosso Senhor e Salvador, Jesus Cristo. A ele seja dada a glória, assim agora, como no dia da eternidade. Amém.",
  },
];
