export const fpe3 = [
  ...
  { number: 2, text: "Considerando a vossa vida casta, em temor." },
  {
    number: 3,
    text: "O enfeite delas não seja o exterior, no frisado dos cabelos, no uso de jóias de ouro, na compostura dos vestidos;",
  },
  {
    number: 4,
  ...
  {
    number: 14,
    text: "Mas também, se padecerdes por amor da justiça, sois bemaventurados. E não temais com medo deles, nem vos turbeis;",
  },
  {
    number: 15,
  ...
  {
    number: 16,
    text: "Tendo uma boa consciência, para que, naquilo em que falam mal de vós, como de malfeitores, fiquem confundidos os que blasfemam do vosso bom porte em Cristo.",
  },
  {
    number: 17,
