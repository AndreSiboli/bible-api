export const mc5 = [
  ...
  { number: 6, text: "E, quando viu Jesus ao longe, correu e adorou-o." },
  {
    number: 7,
  ...
  { number: 8, text: "(Porque lhe dizia: Sai deste homem, espírito imundo.)" },
  {
    number: 9,
  ...
  {
    number: 14,
    text: "E os que apascentavam os porcos fugiram, e o anunciaram na cidade e nos campos; e saíram muitos a ver o que era aquilo que tinha acontecido.",
  },
  {
    number: 15,
  ...
  { number: 17, text: "E começaram a rogar-lhe que saísse dos seus termos." },
  {
    number: 18,
  ...
  {
    number: 30,
    text: "E logo Jesus, conhecendo que a virtude de si mesmo saíra, voltou-se para a multidão, e disse: Quem tocou nas minhas vestes?",
  },
  {
    number: 31,
    text: "E disseram-lhe os seus discípulos: Vês que a multidão te aperta, e dizes: Quem me tocou?",
  },
  { number: 32, text: "E ele olhava em redor, para ver a que isto fizera." },
  {
    number: 33,
  ...
  {
    number: 35,
    text: "Estando ele ainda falando, chegaram alguns do principal da sinagoga, a quem disseram: A tuafilha está morta; para que enfadas mais o Mestre?",
  },
  {
    number: 36,
