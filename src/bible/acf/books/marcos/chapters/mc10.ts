export const mc10 = [
  {
    number: 1,
    text: "E, levantando-se dali, foi para os termos da Judéia, além do Jordão, e a multidão se reuniu em torno dele; e tornou a ensiná-los, como tinha por costume.",
  },
  {
    number: 2,
  ...
  {
    number: 8,
    text: "E serão os dois uma só carne; e assim já não serão dois, mas uma só carne.",
  },
  { number: 9, text: "Portanto, o que Deus ajuntou não o separe o homem." },
  {
    number: 10,
  ...
  {
    number: 20,
    text: "Ele, porém, respondendo, lhe disse: Mestre, tudo isso guardei desde a minha mocidade.",
  },
  {
    number: 21,
  ...
  {
    number: 31,
    text: "Porém muitos primeiros serão derradeiros, e muitos derradeiros serão primeiros.",
  },
  {
    number: 32,
  ...
  {
    number: 33,
    text: "Dizendo: Eis que nós subimos a Jerusalém, e o Filho do homem será entregue aos príncipes dos sacerdotes, e aos escribas, e o condenarão à morte, e o entregarão aos gentios.",
  },
  {
    number: 34,
  ...
  { number: 36, text: "E ele lhes disse: Que quereis que vos faça?" },
  {
    number: 37,
  ...
  {
    number: 46,
    text: "E depois, foram para Jericó. E, saindo ele de Jericó com seus discípulos e uma grande multidão, Bartimeu, o cego, filho de Timeu, estava assentado junto do caminho, mendigando.",
  },
  {
    number: 47,
