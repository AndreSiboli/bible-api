export const mc8 = [
  ...
  { number: 9, text: "E os que comeram eram quase quatro mil; e despediu-os." },
  {
    number: 10,
  ...
  {
    number: 11,
    text: "E saíram os fariseus, e começaram a disputar com ele, pedindolhe, para o tentarem, um sinal do céu.",
  },
  {
    number: 12,
  ...
  {
    number: 19,
    text: "Quando parti os cinco pães entre os cinco mil, quantas alcofas cheias de pedaços levantastes? Disseram-lhe: Doze.",
  },
  {
    number: 20,
    text: "E, quando parti os sete entre os quatro mil, quantos cestos cheios de pedaços levantastes? E disseram-lhe: Sete.",
  },
  { number: 21, text: "E ele lhes disse: Como não entendeis ainda?" },
  {
    number: 22,
  ...
  {
    number: 27,
    text: "E saiu Jesus, e os seus discípulos, para as aldeias de Cesaréia de Filipe; e no caminho perguntou aos seus discípulos, dizendo: Quem dizem os homens que eu sou?",
  },
  {
    number: 28,
  ...
  {
    number: 31,
    text: "E começou a ensinar-lhes que importava que o Filho do homem padecesse muito, e que fosse rejeitado pelos anciãos e príncipes dos sacerdotes, e pelos escribas, e que fosse morto, mas que depois de três dias ressuscitaria.",
  },
  {
    number: 32,
  ...
  { number: 37, text: "Ou, que daria o homem pelo resgate da sua alma?" },
  {
    number: 38,
