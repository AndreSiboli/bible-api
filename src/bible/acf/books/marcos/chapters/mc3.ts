export const mc3 = [
  ...
  {
    number: 2,
    text: "E estavam observando-o securaria no sábado, para o acusarem.",
  },
  {
    number: 3,
  ...
  {
    number: 7,
    text: "E retirou-se Jesus com os seus discípulos para o mar, e seguia-o uma grande multidão da Galiléia e da Judéia,",
  },
  {
    number: 8,
    text: "E de Jerusalém, e da Iduméia, e de além do Jordão, e de perto de Tiro e de Sidom; uma grande multidão que, ouvindo quão grandes coisas fazia, vinha ter com ele.",
  },
  {
    number: 9,
    text: "E ele disse aos seus discípulos que lhe tivessem sempre pronto um barquinho junto dele, por causa da multidão, para que o não oprimisse,",
  },
  {
    number: 10,
    text: "Porque tinha curado a muitos, de tal maneira que todos quantos tinham algum mal se arrojavam sobre ele, para lhe tocarem.",
  },
  {
    number: 11,
  ...
  {
    number: 15,
    text: "E para que tivessem o poderde curar as enfermidades e expulsar os demônios:",
  },
  { number: 16, text: "A Simão, a quem pôs o nome de Pedro," },
  {
    number: 17,
  ...
  { number: 19, text: "E a Judas Iscariotes, o que o entregou." },
  {
    number: 20,
  ...
  {
    number: 27,
    text: "Ninguém pode roubar os bens do valente, entrando-lhe em sua casa, se primeiro não maniatar o valente; e então roubará a sua casa.",
  },
  {
    number: 28,
  ...
  {
    number: 29,
    text: "Qualquer, porém, que blasfemar contra o Espírito Santo, nunca obterá perdão, mas será réu do eterno juízo",
  },
  { number: 30, text: "(Porque diziam: Tem espírito imundo)." },
  {
    number: 31,
