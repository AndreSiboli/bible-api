export const js15 = [
  ...
  { number: 22, text: "E Quiná, e Dimona, e Adada," },
  { number: 23, text: "E Quedes, e Hazor, e Itnã," },
  { number: 24, text: "Zife, e Telem, e Bealote," },
  { number: 25, text: "E Hazor-Hadata, e Queriote-Hezrom (que é Hazor)," },
  { number: 26, text: "Amã e Sema, e Moladá," },
  { number: 27, text: "E Hazar-Gada, e Hesmom, e Bete-Palete," },
  { number: 28, text: "E Hazar-Sual, e Berseba, e Biziotiá," },
  { number: 29, text: "Baalá, e Iim, e Azem," },
  { number: 30, text: "E Eltolade, e Quesil, e Hormá." },
  { number: 31, text: "E Ziclague, e Madmana, e Sansana," },
  {
    number: 32,
    text: "E Lebaote, e Silim, e Aim, e Rimom; todas as cidades e as suas aldeias, vinte e nove.",
  },
  { number: 33, text: "Nas planícies: Estaol, e Zorá, e Asná," },
  { number: 34, text: "E Zanoa, e En-Ganim, Tapua, e Enã." },
  { number: 35, text: "E Jarmute, e Adulão, Socó, e Azeca," },
  {
    number: 36,
    text: "E Saaraim, e Aditaim, e Gederá, e Gederotaim; catorze cidades e as suas aldeias.",
  },
  { number: 37, text: "Zenã, e Hadasa, e Migdal-Gade," },
  { number: 38, text: "E Dileã, e Mizpe, e Jocteel," },
  { number: 39, text: "Laquis, e Bozcate, e Eglom," },
  { number: 40, text: "E Cabom, e Laamás, e Quitlis," },
  {
    number: 41,
    text: "E Gederote, Bete-Dagom, e Naamá, e Maquedá, dezesseis cidades e as suas aldeias.",
  },
  { number: 42, text: "Libna, e Eter, e Asã," },
  { number: 43, text: "E Iftá, e Asná, e Nezibe," },
  {
    number: 44,
    text: "E Queila, e Aczibe, e Maressa; nove cidades e as suas aldeias.",
  },
  { number: 45, text: "Ecrom, com suas vilas, e as suas aldeias." },
  {
    number: 46,
  ...
  { number: 48, text: "E nas montanhas: Samir, Jatir, e Socó." },
  { number: 49, text: "E Daná, e Quiriate-Saná (que é Debir)," },
  { number: 50, text: "E Anabe, Estemó, e Anim," },
  {
    number: 51,
    text: "E Gósen, e Holom, e Giló; onze cidades e as suas aldeias.",
  },
  { number: 52, text: "Arabe, e Dumá e Esã," },
  { number: 53, text: "E Janim, e Bete-Tapua e Afeca," },
  {
    number: 54,
    text: "E Hunta, e Quiriate-Arba (que é Hebrom), e Zior; nove cidades e as suas aldeias.",
  },
  { number: 55, text: "Maom, Carmelo, e Zife, e Jutá," },
  { number: 56, text: "E Jizreel, e Jocdeão, e Zanoa," },
  { number: 57, text: "Caim, Gibeá, e Timna; dez cidades e as suas aldeias." },
  { number: 58, text: "Halul, Bete-Zur, e Gedor," },
  {
    number: 59,
  ...
  { number: 61, text: "No deserto: Bete-Arabá, Midim, e Secacá," },
  {
    number: 62,
