export const rm12 = [
    ...
    { number: 7, text: 'Se o seu dom é servir, sirva; se é ensinar, ensine;' },
    {
        number: 8,
    ...
    { number: 9, text: 'O amor deve ser sincero. Odeiem o que é mau; apeguem-se ao que é bom.' },
    {
        number: 10,
    ...
    { number: 14, text: 'Abençoem aqueles que os perseguem; abençoem, e não os amaldiçoem.' },
    { number: 15, text: 'Alegrem-se com os que se alegram; chorem com os que choram.' },
    {
        number: 16,
    ...
    { number: 18, text: 'Façam todo o possível para viver em paz com todos.' },
    {
        number: 19,
    ...
    { number: 21, text: 'Não se deixem vencer pelo mal, mas vençam o mal com o bem.' },
];
