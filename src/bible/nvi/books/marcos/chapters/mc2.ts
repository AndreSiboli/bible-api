export const mc2 = [
    ...
    { number: 6, text: 'Estavam sentados ali alguns mestres da lei, raciocinando em seu íntimo:' },
    {
        number: 7,
    ...
    { number: 11, text: 'eu lhe digo: Levante-se, pegue a sua maca e vá para casa".' },
    {
        number: 12,
    ...
    { number: 20, text: 'Mas virão dias quando o noivo lhes será tirado; e nesse tempo jejuarão.' },
    {
        number: 21,
    ...
    { number: 28, text: 'Assim, pois, o Filho do homem é Senhor até mesmo do sábado".' },
];
