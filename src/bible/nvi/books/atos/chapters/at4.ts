export const at4 = [
    ...
    { number: 15, text: 'Assim, ordenaram que se retirassem do Sinédrio e começaram a discutir,' },
    {
        number: 16,
    ...
    { number: 20, text: 'Pois não podemos deixar de falar do que vimos e ouvimos".' },
    {
        number: 21,
