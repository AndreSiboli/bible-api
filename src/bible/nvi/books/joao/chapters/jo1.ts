export const jo1 = [
    ...
    { number: 6, text: 'Surgiu um homem enviado por Deus, chamado João.' },
    {
        number: 7,
        text: 'Ele veio como testemunha, para testificar acerca da luz, a fim de que por meio dele todos os homens cressem.',
    },
    { number: 8, text: 'Ele próprio não era a luz, mas veio como testemunha da luz.' },
    { number: 9, text: 'Estava chegando ao mundo a verdadeira luz, que ilumina todos os homens.' },
    {
        number: 10,
        text: 'Aquele que é a Palavra estava no mundo, e o mundo foi feito por intermédio dele, mas o mundo não o reconheceu.',
    },
    { number: 11, text: 'Veio para o que era seu, mas os seus não o receberam.' },
    {
        number: 12,
    ...
    { number: 16, text: 'Todos recebemos da sua plenitude, graça sobre graça.' },
    {
        number: 17,
    ...
    { number: 20, text: 'Ele confessou e não negou; declarou abertamente: "Não sou o Cristo".' },
    {
        number: 21,
    ...
    { number: 24, text: 'Alguns fariseus que tinham sido enviados' },
    {
        number: 25,
    ...
    { number: 34, text: 'Eu vi e testifico que este é o Filho de Deus".' },
    { number: 35, text: 'No dia seguinte João estava ali novamente com dois dos seus discípulos.' },
    { number: 36, text: 'Quando viu Jesus passando, disse: "Vejam! É o Cordeiro de Deus! "' },
    { number: 37, text: 'Ouvindo-o dizer isso, os dois discípulos seguiram a Jesus.' },
    {
        number: 38,
    ...
    { number: 44, text: 'Filipe, como André e Pedro, era da cidade de Betsaida.' },
    {
        number: 45,
