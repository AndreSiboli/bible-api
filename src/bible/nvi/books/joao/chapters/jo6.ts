export const jo6 = [
    ...
    { number: 3, text: 'Então Jesus subiu ao monte e sentou-se com os seus discípulos.' },
    { number: 4, text: 'Estava próxima a festa judaica da Páscoa.' },
    {
        number: 5,
    ...
    { number: 8, text: 'Outro discípulo, André, irmão de Simão Pedro, tomou a palavra:' },
    {
        number: 9,
    ...
    { number: 16, text: 'Ao anoitecer seus discípulos desceram para o mar,' },
    {
        number: 17,
    ...
    { number: 18, text: 'Soprava um vento forte, e as águas estavam agitadas.' },
    {
        number: 19,
    ...
    { number: 20, text: 'Mas ele lhes disse: "Sou eu! Não tenham medo! "' },
    {
        number: 21,
    ...
    { number: 29, text: 'Jesus respondeu: "A obra de Deus é esta: crer naquele que ele enviou".' },
    {
        number: 30,
    ...
    { number: 33, text: 'Pois o pão de Deus é aquele que desceu do céu e dá vida ao mundo".' },
    { number: 34, text: 'Disseram eles: "Senhor, dá-nos sempre desse pão! "' },
    {
        number: 35,
    ...
    { number: 36, text: 'Mas, como eu lhes disse, vocês me viram, mas ainda não crêem.' },
    {
        number: 37,
    ...
    { number: 43, text: 'Respondeu Jesus: "Parem de fazer-me críticas.' },
    {
        number: 44,
    ...
    { number: 47, text: 'Asseguro-lhes que aquele que crê tem a vida eterna.' },
    { number: 48, text: 'Eu sou o pão da vida.' },
    { number: 49, text: 'Os seus antepassados comeram o maná no deserto, mas morreram.' },
    {
        number: 50,
    ...
    { number: 59, text: 'Ele disse isso quando ensinava na sinagoga de Cafarnaum.' },
    {
        number: 60,
    ...
    { number: 67, text: 'Jesus perguntou aos Doze: "Vocês também não querem ir? "' },
    {
        number: 68,
        text: 'Simão Pedro lhe respondeu: "Senhor, para quem iremos? Tu tens as palavras de vida eterna.',
    },
    { number: 69, text: 'Nós cremos e sabemos que és o Santo de Deus".' },
    {
        number: 70,
