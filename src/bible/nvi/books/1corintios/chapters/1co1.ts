export const fco1 = [
    ...
    { number: 6, text: 'porque o testemunho de Cristo foi confirmado entre vocês,' },
    {
        number: 7,
    ...
    { number: 15, text: 'de modo que ninguém pode dizer que foi batizado em meu nome.' },
    {
        number: 16,
    ...
    { number: 22, text: 'Os judeus pedem sinais miraculosos, e os gregos procuram sabedoria;' },
    {
        number: 23,
    ...
    { number: 29, text: 'para que ninguém se vanglorie diante dele.' },
    {
        number: 30,
    ...
    { number: 31, text: 'para que, como está escrito: "Quem se gloriar, glorie-se no Senhor".' },
];
