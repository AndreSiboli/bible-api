export const mt7 = [
    { number: 1, text: '"Não julguem, para que vocês não sejam julgados.' },
    {
        number: 2,
    ...
    { number: 9, text: '"Qual de vocês, se seu filho pedir pão, lhe dará uma pedra?' },
    { number: 10, text: 'Ou se pedir peixe, lhe dará uma cobra?' },
    {
        number: 11,
    ...
    { number: 19, text: 'Toda árvore que não produz bons frutos é cortada e lançada ao fogo.' },
    { number: 20, text: 'Assim, pelos seus frutos vocês os reconhecerão!' },
    {
        number: 21,
