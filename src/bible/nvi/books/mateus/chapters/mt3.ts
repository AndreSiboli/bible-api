export const mt3 = [
    { number: 1, text: 'Naqueles dias surgiu João Batista, pregando no deserto da Judéia.' },
    { number: 2, text: 'Ele dizia: "Arrependam-se, porque o Reino dos céus está próximo".' },
    {
        number: 3,
    ...
    { number: 6, text: 'Confessando os seus pecados, eram batizados por ele no rio Jordão.' },
    {
        number: 7,
    ...
    { number: 8, text: 'Dêem fruto que mostre o arrependimento!' },
    {
        number: 9,
    ...
    { number: 13, text: 'Então Jesus veio da Galiléia ao Jordão para ser batizado por João.' },
    {
        number: 14,
