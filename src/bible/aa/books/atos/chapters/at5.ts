export const at5 = [
  ...
  {
    number: 7,
    text: "Depois de um intervalo de cerca de três horas, entrou também sua mulher, não sabendo o que havia acontecido.",
  },
  {
    number: 8,
  ...
  {
    number: 35,
    text: "e prosseguiu: Varões israelitas, acautelai-vos a respeito do que estais para fazer a estes homens.",
  },
  {
    number: 36,
