export const at13 = [
  ...
  {
    number: 10,
    text: "disse: ó filho do diabo, cheio de todo o engano e de toda a malícia, inimigo de toda a justiça, não cessarás de perverter os caminhos retos do Senhor?",
  },
  {
    number: 11,
  ...
  { number: 20, text: "Depois disto, deu-lhes juízes até o profeta Samuel." },
  {
    number: 21,
  ...
  {
    number: 24,
    text: "havendo João, antes do aparecimento dele, pregado a todo o povo de Israel o batismo de arrependimento.",
  },
  {
    number: 25,
    text: "Mas João, quando completava a carreira, dizia: Quem pensais vós que eu sou? Eu não sou o Cristo, mas eis que após mim vem aquele a quem não sou digno de desatar as alparcas dos pés.",
  },
  {
    number: 26,
