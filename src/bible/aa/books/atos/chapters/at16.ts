export const at16 = [
  ...
  { number: 8, text: "Então, passando pela Mísia, desceram a Trôade." },
  {
    number: 9,
  ...
  {
    number: 10,
    text: "E quando ele teve esta visão, procurávamos logo partir para a Macedônia, concluindo que Deus nos havia chamado para lhes anunciarmos o evangelho.",
  },
  {
    number: 11,
