export const at10 = [
  {
    number: 1,
    text: "Um homem em Cesaréia, por nome Cornélio, centurião da corte chamada italiana,",
  },
  {
    number: 2,
  ...
  { number: 8, text: "e, havendo contado tudo, os enviou a Jope." },
  {
    number: 9,
  ...
  { number: 13, text: "E uma voz lhe disse: Levanta-te, Pedro, mata e come." },
  {
    number: 14,
  ...
  {
    number: 30,
    text: "Então disse Cornélio: Faz agora quatro dias que eu estava orando em minha casa à hora nona, e eis que diante de mim se apresentou um homem com vestiduras resplandecentes,",
  },
  {
    number: 31,
  ...
  {
    number: 41,
    text: "não a todo povo, mas às testemunhas que Deus antes ordenara; a nós, que comemos e bebemos juntamente com ele depois que ressurgiu dentre os mortos.",
  },
  {
    number: 42,
